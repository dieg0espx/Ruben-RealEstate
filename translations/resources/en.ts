export const resourcesTranslations = {
  hero: {
    ...
    subtitle: "Free guides, videos, and articles to help you make informed real estate decisions. Position yourself as a knowledgeable buyer, seller, or investor."
  },
  categories: {
    freeGuides: {
      title: "Free Guides",
