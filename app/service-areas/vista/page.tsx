          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
            <div className="text-center space-y-6">
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white font-lexend leading-tight">
                {language === 'en' ? 'Real Estate Services Vista' : 'Servicios Inmobiliarios en Vista'}
              </h1>
              <p className="text-xl sm:text-2xl text-white/90 max-w-4xl mx-auto leading-relaxed">
                {language === 'en' 
                  ...
                  : 'Experto inmobiliario de confianza en Vista que ayuda a familias, veteranos e inversionistas a comprar, vender e invertir con comunicación clara y atención.'}
              </p>
            ...
            <div className="prose prose-lg max-w-none space-y-6 text-muted-foreground leading-relaxed">
              ...
              <div className="my-8">
                <Button 
                  ...
                  onClick={() => window.location.href = '/contact'}
                >
                  {language === 'en' ? 'Begin Your Vista Home Journey Today' : 'Comienza Tu Camino de Hogar en Vista Hoy'}
                </Button>
              </div>
        ...
        <section className="py-16 sm:py-20 lg:py-24 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10">
            <h2 className="text-3xl sm:text-4xl font-bold text-white font-lexend text-center mb-12">
              {language === 'en' ? 'Vista Real Estate FAQ' : 'Preguntas Frecuentes de Bienes Raíces en Vista'}
            </h2>
        ...
        <section className="py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-coastal-cream/30 to-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <h2 className="text-3xl sm:text-4xl font-bold text-coastal-sage font-lexend text-center mb-12">
              {language === 'en' ? 'Explore Vista, California' : 'Explora Vista, California'}
            </h2>
        ...
        <section className="py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-coastal-cream/30 to-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center space-y-8">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-foreground font-lexend">
              {language === 'en' ? 'Ready to Get Started in Vista?' : '¿Listo para Comenzar en Vista?'}
            </h2>
