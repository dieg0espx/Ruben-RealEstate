      ...
      <main className="flex-1 bg-background">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
            <div className="text-center space-y-6">
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white font-lexend leading-tight">
                {language === 'en' ? 'Real Estate Services San Marcos' : 'Servicios Inmobiliarios en San Marcos'}
              </h1>
              <p className="text-xl sm:text-2xl text-white/90 max-w-4xl mx-auto leading-relaxed">
                {language === 'en'
                  ...
                  : 'Guiando a familias, veteranos e inversionistas de San Marcos en compra, venta y administración de propiedades con confianza, cuidado y experiencia local.'}
              </p>
        ...
        <section className="py-16 sm:py-20 lg:py-24 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-coastal-sage font-lexend mb-8">
              {language === 'en' ? 'Helping Families and Investors Build Their Future in San Marcos' : 'Ayudando a Familias e Inversionistas a Construir su Futuro en San Marcos'}
            </h2>
            ...
            <div className="prose prose-lg max-w-none space-y-6 text-muted-foreground leading-relaxed">
              ...
              <div className="my-8">
                <Button 
                  ...
                  onClick={() => window.location.href = '/contact'}
                >
                  {language === 'en' ? 'Schedule Your San Marcos Property Consultation' : 'Programa Tu Consulta de Propiedad en San Marcos'}
                </Button>
              </div>
        ...
        <section className="py-16 sm:py-20 lg:py-24 relative overflow-hidden">
          <div 
            className="absolute inset-0 bg-cover bg-center bg-fixed"
            style={{
              backgroundImage: "url('/images/1-web-or-mls-royal (6 of 47).JPG')",
              backgroundAttachment: "fixed"
            }}
          ></div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10">
            <h2 className="text-3xl sm:text-4xl font-bold text-white font-lexend text-center mb-12">
              {language === 'en' ? 'San Marcos Real Estate FAQ' : 'Preguntas Frecuentes de Bienes Raíces en San Marcos'}
            </h2>
        ...
        <section className="py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-coastal-cream/30 to-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <h2 className="text-3xl sm:text-4xl font-bold text-coastal-sage font-lexend text-center mb-12">
              {language === 'en' ? 'Explore San Marcos, California' : 'Explora San Marcos, California'}
            </h2>
        ...
        <section className="py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-coastal-cream/30 to-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center space-y-8">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-foreground font-lexend">
              {language === 'en' ? 'Ready to Get Started in San Marcos?' : '¿Listo para Comenzar en San Marcos?'}
            </h2>
